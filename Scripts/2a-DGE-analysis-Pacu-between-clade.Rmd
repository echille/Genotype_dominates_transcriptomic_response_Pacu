---
title: "2b) *P. acuta* Differential Gene Expression analysis between genotype and ploidy"
output:
...
up.DEGs <- filter(DEGs, log2FoldChange>2)
up.DEGs$contrast <- paste0("Up.",up.DEGs$contrast,sep="")
down.DEGs <- filter(DEGs, log2FoldChange<(-2))

...
```{r}
treatmentinfo <- filter(treatmentinfo, Treatment%in%c("ATAC", "HTAC") & Timepoint=="4_week")
...
pdf("Output/2b-Mcap-4week-temperature-DEG-heatmap.pdf", width = 10.5, height = 7)
draw(DEGheatmap)
dev.off()
```
...
ggsave("Output/2b-Mcap-4week-temperature-DEGs-PCA.pdf", DEG_PCA)
```